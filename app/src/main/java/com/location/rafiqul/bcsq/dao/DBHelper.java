...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String COMMON_UPDATE_COUNT = "updateCount";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "create table " + CATEGORY_TABLE_NAME + " " +
                        "(id integer primary key autoincrement, " + CATEGORY_COLUMN_ID + " integer," + CATEGORY_COLUMN_NAME + " text," + CATEGORY_COLUMN_DESCRIPTION + " text, " + CATEGORY_COLUMN_STATUS + " integer," + COMMON_UPDATE_COUNT + " INTEGER DEFAULT 0)"
        );
        db.execSQL(
                "create table " + SUBCATEGORY_TABLE_NAME + " " +
                        "(id integer primary key autoincrement," + SUBCATEGORY_COLUMN_CATEGORYID + " integer, " + SUBCATEGORY_COLUMN_SUBCATEGORYID + " integer," + SUBCATEGORY_COLUMN_NAME + " text," + SUBCATEGORY_COLUMN_DESCRIPTION + " text, " + SUBCATEGORY_COLUMN_STATUS + " integer," + COMMON_UPDATE_COUNT + " INTEGER DEFAULT 0)"
        );
        db.execSQL(
                "create table " + QUESTION_TABLE_NAME + " " +
                        "(id integer primary key autoincrement," + QUESTION_COLUMN_QUESTIONID + " integer, " + QUESTION_COLUMN_SUBCATEGORYID + " integer," + QUESTION_COLUMN_QUESTION + " text," + QUESTION_COLUMN_DESCRIPTION + " text," + QUESTION_COLUMN_ANSWER + " text, " + QUESTION_COLUMN_STATUS + " integer," + QUESTION_COLUMN_IS_MULTIPLEANS + " integer," + COMMON_UPDATE_COUNT + " INTEGER DEFAULT 0)"
        );
        db.execSQL(
                "create table " + ANSWER_TABLE_NAME + " " +
                        "(id integer primary key autoincrement," + ANSWER_COLUMN_ANSWERID + " integer, " + ANSWER_COLUMN_QUESTIONID + " integer," + ANSWER_COLUMN_ANSWER1 + " text," + ANSWER_COLUMN_ANSWER2 + " text," + ANSWER_COLUMN_ANSWER3 + " text," + ANSWER_COLUMN_ANSWER4 + " text, " + ANSWER_COLUMN_CUR_ANS + " integer," + COMMON_UPDATE_COUNT + " INTEGER DEFAULT 0)"
        );
    }
    ...
    public Category getCategoryById(int todo_id) {
        ...
        if (c != null && c.moveToFirst()) {
            ...
            category.setUpdateCount(c.getInt(c.getColumnIndex(COMMON_UPDATE_COUNT)));
        }
        return category;
    }
    ...
    public Subcategory getSubCategoryById(int id) {
        ...
        if (c != null && c.moveToFirst()) {
            ...
            subcategory.setUpdateCount(c.getInt(c.getColumnIndex(COMMON_UPDATE_COUNT)));
        }
        return subcategory;
    }
    ...
    public Question getQuestionById(int id) {
        ...
        if (c != null && c.moveToFirst()) {
            ...
            question.setUpdateCount(c.getInt(c.getColumnIndex(COMMON_UPDATE_COUNT)));
    ...
    public Answer getAnswerById(int id) {
        ...
        if (c != null && c.moveToFirst()) {
            ...
            answer.setUpdateCount(c.getInt(c.getColumnIndex(COMMON_UPDATE_COUNT)));
    ...
    public boolean updateCategoryByColumn(Category category, String columnName, String columnValue) {
        SQLiteDatabase db = this.getWritableDatabase();
        String sql = "update " + CATEGORY_TABLE_NAME + "" +
                " set " + COMMON_UPDATE_COUNT + "=" + COMMON_UPDATE_COUNT + "+1," +
                " " + CATEGORY_COLUMN_NAME + "='" + category.getName() + "'," +
                "" + CATEGORY_COLUMN_DESCRIPTION + "='" + category.getDescription() + "'" +
                "," + CATEGORY_COLUMN_STATUS + "=" + category.getSatus()+" where "+columnName+"="+columnValue+"";
        db.execSQL(sql);
        return true;
    }
    public boolean updateSubCategoryByColumn(Subcategory subcategory, String columnName, String columnValue) {
        SQLiteDatabase db = this.getWritableDatabase();
        String sql = "update " + SUBCATEGORY_TABLE_NAME + "" +
                " set " + COMMON_UPDATE_COUNT + "=" + COMMON_UPDATE_COUNT + "+1," +
                " " + SUBCATEGORY_COLUMN_NAME + "='" + subcategory.getName() + "'," +
                "" + SUBCATEGORY_COLUMN_DESCRIPTION + "='" + subcategory.getDescription() + "'," +
                "" + SUBCATEGORY_COLUMN_CATEGORYID + "=" + subcategory.getCategoryId() + "" +
                "," + SUBCATEGORY_COLUMN_STATUS + "=" + subcategory.getSatus()+" where "+columnName+"="+columnValue+"";
        db.execSQL(sql);
        return true;
    }
    public boolean updateQuestionByColumn(Question question, String columnName, String columnValue) {
        SQLiteDatabase db = this.getWritableDatabase();
        String sql = "update " + QUESTION_TABLE_NAME + "" +
                " set " + COMMON_UPDATE_COUNT + "=" + COMMON_UPDATE_COUNT + "+1," +
                " " + QUESTION_COLUMN_QUESTION + "='" +question.getQuestion()+ "'," + QUESTION_COLUMN_ANSWER + "='" +question.getAnswer()+ "'," + QUESTION_COLUMN_DESCRIPTION + "='" +question.getDescription()+ "'," + QUESTION_COLUMN_SUBCATEGORYID + "=" +question.getSubCategoryId()+ "," + QUESTION_COLUMN_IS_MULTIPLEANS + "='" +question.getIsMultipleAns()+ "'," + QUESTION_COLUMN_STATUS + "=" + question.getSatus()+" where "+columnName+"="+columnValue+"";
        db.execSQL(sql);
        return true;
    }
    public boolean updateAnswerByColumn(Answer answer, String columnName, String columnValue) {
        SQLiteDatabase db = this.getWritableDatabase();
        String sql = "update " + ANSWER_TABLE_NAME + "" +
                " set " + COMMON_UPDATE_COUNT + "=" + COMMON_UPDATE_COUNT + "+1," +
                " " + ANSWER_COLUMN_CUR_ANS+ "=" +answer.getCurAnswer()+ "," + ANSWER_COLUMN_ANSWER1 + "='" +answer.getAnswer1()+ "'," + ANSWER_COLUMN_ANSWER2 + "='" +answer.getAnswer2()+ "'," + ANSWER_COLUMN_ANSWER3 + "='" +answer.getAnswer3()+ "'," + ANSWER_COLUMN_ANSWER4 + "='" +answer.getAnswer4()+ "', where "+columnName+"="+columnValue+"";
        db.execSQL(sql);
        return true;
    }

    public void deleteAnObjectByColumn(String tableName,String columnName,String columnValue) {
